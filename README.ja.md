...
![AI 支援の 3 ペイン コンフリクト解決画面（理由付き）](./docs/screenshots/conflict-resolver.png)

- **AI コンフリクト解決** — ローカルとリモートが分岐した際に自動マージを試み、判断できない場合のみビジュアル解決ダイアログを表示。開くと Local / Remote / AI Suggestion の 3 ペインビュー、AI 信頼度、そしてモデルが選択側を選んだ理由が表示される。
